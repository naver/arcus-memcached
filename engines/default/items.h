...
ENGINE_ERROR_CODE item_apply_list_link(void *engine, const char *key, const uint32_t nkey,
                                       item_attr *attrp);
ENGINE_ERROR_CODE item_apply_set_link(void *engine, const char *key, const uint32_t nkey,
                                      item_attr *attrp);
ENGINE_ERROR_CODE item_apply_map_link(void *engine, const char *key, const uint32_t nkey,
                                      item_attr *attrp);
ENGINE_ERROR_CODE item_apply_btree_link(void *engine, const char *key, const uint32_t nkey,
                                        item_attr *attrp);
ENGINE_ERROR_CODE item_apply_unlink(void *engine, const char *key, const uint32_t nkey);

ENGINE_ERROR_CODE item_apply_list_elem_insert(void *engine, hash_item *it,
                                              const int nelems, const int index,
                                              const char *value, const uint32_t nbytes);
ENGINE_ERROR_CODE item_apply_list_elem_delete(void *engine, hash_item *it,
                                              const int nelems, const int index, const int count,
                                              const bool drop_if_empty);
ENGINE_ERROR_CODE item_apply_set_elem_insert(void *engine, hash_item *it,
                                             const char *value, const uint32_t nbytes);
