...
- <command_name>_hits: 해당 명령의 hit 횟수
- <command_name>_misses: 해당 명령의 key miss 횟수
- <collection_name>\_<command_name>\_elem_hits: 콜렉션 명령의 hit 횟수 
- <collection_name>\_<command_name>\_elem_none_hits: 콜렉션 명령의 index, bkey, field, element miss 횟수
