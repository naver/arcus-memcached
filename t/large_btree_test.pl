...
for (4..4) {
    ...
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $cmd = "bop get $key 1010000..1000001"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    # bop position
    $bkey_A = 2; $posi_A = 0;
    $cmd = "bop position $key $bkey_A asc"; $rst = "POSITION=$posi_A";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = 2; $posi_A = $max_btree_size - 1;
    $cmd = "bop position $key $bkey_A desc"; $rst = "POSITION=$posi_A";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = $max; $posi_A = $max_btree_size - 1;
    $cmd = "bop position $key $bkey_A asc"; $rst = "POSITION=$posi_A";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = $max; $posi_A = 0;
    $cmd = "bop position $key $bkey_A desc"; $rst = "POSITION=$posi_A";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = 20000; $posi_A = 9999;
    $cmd = "bop position $key $bkey_A asc"; $rst = "POSITION=$posi_A";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = 20000; $posi_A = $max_btree_size - 10000;
    $cmd = "bop position $key $bkey_A desc"; $rst = "POSITION=$posi_A";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = $max - 20000; $posi_A = $max_btree_size - 10000 - 1;
    $cmd = "bop position $key $bkey_A asc"; $rst = "POSITION=$posi_A";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = $max - 20000; $posi_A = 10000;
    $cmd = "bop position $key $bkey_A desc"; $rst = "POSITION=$posi_A";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = 33333;
    $cmd = "bop position $key $bkey_A asc"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $bkey_A = $max - 33333;
    $cmd = "bop position $key $bkey_A desc"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    ...
    $cmd = "bop gbp $key desc -1..100"; $rst = "CLIENT_ERROR bad command line format";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $cmd = "bop gbp $key asc 1400000"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $cmd = "bop gbp $key asc 1400000..1500000"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $cmd = "bop gbp $key asc 1500000..1400000"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $cmd = "bop gbp $key desc 1400000"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $cmd = "bop gbp $key desc 1400000..1500000"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
    $cmd = "bop gbp $key desc 1500000..1400000"; $rst = "NOT_FOUND_ELEMENT";
    print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");

    $bkey_A = 0; $bkey_B = 99; $posi_A = 2; $posi_B = 200;
    assert_bop_gbp("$key", "asc",  $bkey_A, $bkey_B, $flags, 100, $posi_A, $posi_B, $width);
    $bkey_A = 99; $bkey_B = 0; $posi_A = 200; $posi_B = 2;
    assert_bop_gbp("$key", "asc",  $bkey_A, $bkey_B, $flags, 100, $posi_A, $posi_B, $width);
    $bkey_A = 0; $bkey_B = 99; $posi_A = $max; $posi_B = $max - 198;
    assert_bop_gbp("$key", "desc",  $bkey_A, $bkey_B, $flags, 100, $posi_A, $posi_B, $width);
    $bkey_A = 99; $bkey_B = 0; $posi_A = $max - 198; $posi_B = $max;
    assert_bop_gbp("$key", "desc",  $bkey_A, $bkey_B, $flags, 100, $posi_A, $posi_B, $width);
    $bkey_A = 10000; $bkey_B = 10099; $posi_A = 20002; $posi_B = 20200;
    assert_bop_gbp("$key", "asc",  $bkey_A, $bkey_B, $flags, 100, $posi_A, $posi_B, $width);
    $bkey_A = 10099; $bkey_B = 10000; $posi_A = 20200; $posi_B = 20002;
    assert_bop_gbp("$key", "asc",  $bkey_A, $bkey_B, $flags, 100, $posi_A, $posi_B, $width);
    $bkey_A = 10000; $bkey_B = 10099; $posi_A = $max - 20000; $posi_B = $max - 20198;
    assert_bop_gbp("$key", "desc",  $bkey_A, $bkey_B, $flags, 100, $posi_A, $posi_B, $width);
    $bkey_A = 10099; $bkey_B = 10000; $posi_A = $max - 20198; $posi_B = $max - 20000;
    assert_bop_gbp("$key", "desc",  $bkey_A, $bkey_B, $flags, 100, $posi_A, $posi_B, $width);
    $bkey_A = 25000; $bkey_B = 25000; $posi_A = 50002; $posi_B = 50002;
    assert_bop_gbp("$key", "asc",  $bkey_A, $bkey_B, $flags,   1, $posi_A, $posi_B, $width);
    $bkey_A = 25000; $bkey_B = 25000; $posi_A = $max - 50000; $posi_B = $max - 50000;
    assert_bop_gbp("$key", "desc",  $bkey_A, $bkey_B, $flags,   1, $posi_A, $posi_B, $width);
    # bop pwg(position with get)
