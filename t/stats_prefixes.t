...
stats_prefixes_is($sock, "PREFIX <null> itm 2 kitm 2 litm 0 sitm 0 bitm 0");
...
print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
stats_prefixes_is($sock, "PREFIX <null> itm 3 kitm 2 litm 0 sitm 0 bitm 1");
...
stats_prefixes_is($sock, "PREFIX <null> itm 5 kitm 2 litm 2 sitm 0 bitm 1");

# insert set
sop_insert("stats_prefixes_set", 0, 2, "create", 13, 0, 0);
stats_prefixes_is($sock, "PREFIX <null> itm 6 kitm 2 litm 2 sitm 1 bitm 1");


# delete
print $sock "delete stats_prefixes_aa\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted stats_prefixes_aa");
stats_prefixes_is($sock, "PREFIX <null> itm 5 kitm 1 litm 2 sitm 1 bitm 1");

print $sock "delete stats_prefixes_bb\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted stats_prefixes_bb");
stats_prefixes_is($sock, "PREFIX <null> itm 4 kitm 0 litm 2 sitm 1 bitm 1");

print $sock "delete stats_prefixes_btree\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted stats_prefixes_btree");
stats_prefixes_is($sock, "PREFIX <null> itm 3 kitm 0 litm 2 sitm 1 bitm 0");

print $sock "delete stats_prefixes_list\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted stats_prefixes_list");
stats_prefixes_is($sock, "PREFIX <null> itm 2 kitm 0 litm 1 sitm 1 bitm 0");

print $sock "delete stats_prefixes_list2\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted stats_prefixes_list2");
stats_prefixes_is($sock, "PREFIX <null> itm 1 kitm 0 litm 0 sitm 1 bitm 0");
...
stats_prefixes_is($sock, "PREFIX aa itm 2 kitm 2 litm 0 sitm 0 bitm 0");
...
print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
stats_prefixes_is($sock, "PREFIX aa itm 3 kitm 2 litm 0 sitm 0 bitm 1");
...
stats_prefixes_is($sock, "PREFIX aa itm 5 kitm 2 litm 2 sitm 0 bitm 1");

# insert set
sop_insert("aa:stats_prefixes_set", 0, 2, "create", 13, 0, 0);
stats_prefixes_is($sock, "PREFIX aa itm 6 kitm 2 litm 2 sitm 1 bitm 1");


# delete
print $sock "delete aa:stats_prefixes_aa\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted aa:stats_prefixes_aa");
stats_prefixes_is($sock, "PREFIX aa itm 5 kitm 1 litm 2 sitm 1 bitm 1");

print $sock "delete aa:stats_prefixes_bb\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted aa:stats_prefixes_bb");
stats_prefixes_is($sock, "PREFIX aa itm 4 kitm 0 litm 2 sitm 1 bitm 1");

print $sock "delete aa:stats_prefixes_btree\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted aa:stats_prefixes_btree");
stats_prefixes_is($sock, "PREFIX aa itm 3 kitm 0 litm 2 sitm 1 bitm 0");

print $sock "delete aa:stats_prefixes_list\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted aa:stats_prefixes_list");
stats_prefixes_is($sock, "PREFIX aa itm 2 kitm 0 litm 1 sitm 1 bitm 0");

print $sock "delete aa:stats_prefixes_list2\r\n";
is(scalar <$sock>, "DELETED\r\n", "deleted aa:stats_prefixes_list2");
stats_prefixes_is($sock, "PREFIX aa itm 1 kitm 0 litm 0 sitm 1 bitm 0");
...
stats_prefixes_is($sock, "PREFIX aa itm 6 kitm 2 litm 2 sitm 1 bitm 1,PREFIX bb itm 2 kitm 2 litm 0 sitm 0 bitm 0");
...
print $sock "$cmd\r\n"; is(scalar <$sock>, "$rst\r\n", "$cmd: $rst");
stats_prefixes_is($sock, "PREFIX aa itm 6 kitm 2 litm 2 sitm 1 bitm 1,PREFIX bb itm 3 kitm 2 litm 0 sitm 0 bitm 1");
...
stats_prefixes_is($sock, "PREFIX aa itm 6 kitm 2 litm 2 sitm 1 bitm 1,PREFIX bb itm 5 kitm 2 litm 2 sitm 0 bitm 1");

# insert set
sop_insert("bb:stats_prefixes_set", 0, 2, "create", 13, 0, 0);
stats_prefixes_is($sock, "PREFIX aa itm 6 kitm 2 litm 2 sitm 1 bitm 1,PREFIX bb itm 6 kitm 2 litm 2 sitm 1 bitm 1");
